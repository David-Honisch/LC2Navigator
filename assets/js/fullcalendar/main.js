							...
							.fullCalendar(
									{
										...
										// events: [{"id":"14","title":"New
										// Event","start":"2015-01-24T16:00:00+04:00","allDay":false}],
										utc : true,
										header : {
										...
										eventDrop : function(event, delta,
											...
											var end = (event.end == null) ? start
													: event.end.format();
											$
													.ajax({
														url : 'process.php',
														data : 'type=resetdate&title='
																+ title
																+ '&start='
																+ start
																+ '&end='
