...
************************************************************************************************************/
	...
	function createNewWindow(width,height,left,top)
	{
		...
		img.src = './img/fw/tleft.gif';
		img.align='left';
		topDiv.appendChild(img);
		
		var img = document.createElement('IMG');
		img.src = './img/fw/tcenter.gif';
		...
		var img = document.createElement('IMG');
		img.src = './img/fw/minimize.gif';
		img.className='minimizeButton';
		buttonDiv.appendChild(img);	
		
		var img = document.createElement('IMG');
		img.src = './img/fw/close.gif';
		img.className='closeButton';
		buttonDiv.appendChild(img);	
		
		var img = document.createElement('IMG');
		img.src = './img/fw/tright.gif';
		buttonDiv.appendChild(img);		
		...
		var img = document.createElement('IMG');
		img.src = './img/fw/bottom_right.gif';
