...
jQuery(document).ready(function() {
	$.getScript('http://maps.google.com/maps?file=api&v=2.144a&key=ABQIAAAAQXTIzdhlW9J36-Fb8ktnfxTF5S45Cxg0OhlO4HEaXNRIxdvytBQlyrGfN_i7ztm4wEufIVQakZSsNg', function() {
		printOut("#out", "Initializing google streetview api...", true);
		centre = new GLatLng(50.942375, 6.962322);				
