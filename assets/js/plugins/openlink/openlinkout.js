...
var game = new Phaser.Game(320 * 2, 256 * 2, Phaser.CANVAS, 'lc2introCanvas', {
	preload : preload,
	create : create,
	update : update
});
...
function preload() {
	...
	game.load.script('protracker', 'js/LC2Intro/_plugins/ProTracker.js');
	game.load.binary('shampoo', 'js/LC2Intro/audio/shampoo.mod', modLoaded, this);
	game.load.image('knightHawks', 'js/LC2Intro/img/knighthawks.png');
	...
	game.load.image('raster', 'js/LC2Intro/img/sunset-raster.png');
	...
	game.load.spritesheet('button', 'js/LC2Intro/img/button_sprite_sheet.png', 193, 71);
}
function createTextScroller() {
	text = game.add.text(32, 450, '', {
		font : "30pt Arial",
		fill : "#19cb65",
		stroke : "#119f4e",
		strokeThickness : 2
	});
	textReflect2 = game.add.text(32, 450, '', {
		font : "30pt Arial",
		fill : "#19cb65",
		stroke : "#119f4e",
		strokeThickness : 2
...
function createText() {
	var x = game.world.centerX / 2 + 50;
	var y = game.world.centerY / 2;
	y = 0;
	var fontSize = 20;
	text2 = game.add.text(x, y, "" + appTitle);
	text2.align = 'center';
	...
	// ""+appTitle);
	textReflect = game.add.text(x, y + 50, "" + appTitle);
...
function createButton() {
	button = game.add.button(game.world.centerX - 95, 500, 'button',
