			...
			function init() {
				...
				scene.fog = new THREE.Fog( 0x000000, 250, 2100 );

				// CAMERA

				//camera = new THREE.PerspectiveCamera( 30, window.innerWidth / window.innerHeight, 1, 1500 );
				camera = new THREE.PerspectiveCamera( 30, window.innerWidth / window.innerHeight, 1, 2200 );
				...
				var effectFilm = new THREE.FilmPass( 0.5, 0.125, 1024, false );
