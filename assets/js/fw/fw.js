...
function createNewWindow(width,height,left,top)
{
	...
	img.src = './assets/img/fw/tleft.gif';
	img.align='left';
	topDiv.appendChild(img);
	
	var img = document.createElement('IMG');
	img.src = './assets/img/fw/tcenter.gif';
	...
	var img = document.createElement('IMG');
	img.src = './assets/img/fw/minimize.gif';
	img.className='minimizeButton';
	buttonDiv.appendChild(img);	
	
	var img = document.createElement('IMG');
	img.src = './assets/img/fw/close.gif';
	img.className='closeButton';
	buttonDiv.appendChild(img);	
	
	var img = document.createElement('IMG');
	img.src = './assets/img/fw/tright.gif';
	buttonDiv.appendChild(img);		
	...
	var img = document.createElement('IMG');
	img.src = './assets/img/fw/bottom_right.gif';
...
function cFCW(urlToExternalFile,width,height,left,top)
{	
	var divId = createNewWindow(width,height,left,top);
	document.getElementById('windowContent' + divId).innerHTML = 'Lade den Inhalt von einem neuen Fenster...';
//	document.getElementById('windowContent' + divId).innerHTML += '<script src="assets/js/main/mainController.js"></script>\n';
	if(urlToExternalFile)addContentFromUrl(urlToExternalFile,divId);			
}
function FCW(cnt,width,height,left,top)
{
	var divId = createNewWindow(width,height,left,top);
	document.getElementById('windowContent' + divId).innerHTML = cnt;			
	}
